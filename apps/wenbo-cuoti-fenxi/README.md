...
1. DevEco Studio 打开 **`apps/wenbo-cuoti-fenxi/app/`** 目录
2. Sync Project → Build → 运行到模拟器或真机
3. API：`https://saas16.qianqi.online/api/v1`，租户 `wenbo-cuoti-fenxi`
4. 管理后台：https://saas16.qianqi.online/ （账号见 `store/admin-account.md`）
