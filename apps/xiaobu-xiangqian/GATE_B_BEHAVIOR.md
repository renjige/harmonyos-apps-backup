...
- status: **fail**
- slug: xiaobu-xiangqian
- productVisualType: ops-tool
- platformBiz: true
- contentImages: 3
- checkedAt: 2026-08-26T09:39:29.909Z
...
5. HUAWEI-异常: 空按钮/空点击 app/entry/src/main/ets/pages/HomePage.ets（审核一点就「没反应」）
...
> Re-run: `npm run gate:behavior -- xiaobu-xiangqian`
