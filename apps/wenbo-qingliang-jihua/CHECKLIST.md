# CHECKLIST（Gate B）— 清凉计划

- requestId: wenbo-qingliang-jihua
- slug: wenbo-qingliang-jihua
- appName: 清凉计划
- industry: cool-plan
...
- [ ] 无死按钮
- [ ] 列表有数据或空态
- [ ] **新用户登录后无测试数据**（用户活动列表为空）
- [ ] **二级 / 三级页功能完整**（列表→详情→CTA）
- [ ] 核心业务流可走通
...
- [ ] **无独立隐私授权首屏**；协议勾选在登录/注册页
- [ ] 同意前不采数不申权
- [ ] 协议可打开全文 Overlay
- [ ] 收集清单与共享清单
- [ ] 注销账号 / 撤回同意；**禁止「删除业务数据」按钮**；可按需「清除缓存」
...
- [ ] `apps/{slug}/README.md` 含当前 App 名称；已指出上架图标路径

## B14 浅色 / 深色对比度

- [ ] 浅色与深色模式控件文字与背景高对比（标题 ≥3:1，正文 ≥4.5:1）
