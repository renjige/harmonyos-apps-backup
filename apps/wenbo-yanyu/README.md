...
当前 App 名称：**研语** · 版本 **1.7.0**

魏文波 · HarmonyOS NEXT

润色表达，也把学习与思考沉淀成自己的研究资料。

五 Tab：**首页 / 表达 / 研究 / 成长 / 我的**（v1.2 工作台架构）。研究 Tab 为本机知识整理（笔记、专题、标签、灵感库、时间线等），新用户列表为空。
...
- 浅色/深色模式文字与背景高对比；我的页切换后立即刷新，无需再切 Tab
