...
- status: **pass**
- slug: wenbo-dushu-zhayu
- productVisualType: content-commerce
- platformBiz: true
- contentImages: 27
- checkedAt: 2026-09-02T07:58:56.063Z
...
- B12 9 detail pane(s) with Image+CTA
- Gate C 27 content images (min 5)
- Gate C HomePage 5 media Image refs
...
- HUAWEI-简单: 9 种 DetailPane
- HUAWEI-简单: 首页有足够区块
- HUAWEI-简单: 4 个文件含写操作 API
- HUAWEI-50104: 24 个业务页
- HUAWEI-50104: differentiation.md 存在
- HUAWEI-50104: 56 处写/提交逻辑

> Re-run: `npm run gate:behavior -- wenbo-dushu-zhayu`
