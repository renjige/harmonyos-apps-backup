...
- status: **pass**
- slug: wenbo-qiuxing-fengcai
- productVisualType: sports-profiles
- platformBiz: true
- contentImages: 18
- checkedAt: 2026-08-31T08:48:56.213Z
...
- Gate C 18 content images (min 2)
...
- HUAWEI-简单: 首页有足够区块
- HUAWEI-简单: feature-list 22 项 ✅
- HUAWEI-简单: 4 个文件含写操作 API
- HUAWEI-50104: 14 个业务页
- HUAWEI-50104: differentiation.md 存在
- HUAWEI-50104: 36 处写/提交逻辑

> Re-run: `npm run gate:behavior -- wenbo-qiuxing-fengcai`
