...
INSERT INTO messages (user_id, title, body, type, read) VALUES
  ('00000000-0000-0000-0000-000000000001', '整改临期提醒', '「连墙件间距超标」将于 48 小时内到期，请尽快闭环。', 'inspection', FALSE),
  ('00000000-0000-0000-0000-000000000001', '周报已生成', '本周巡检汇总可通过 AI 助手查看。', 'ai', TRUE);
