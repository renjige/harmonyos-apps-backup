#!/usr/bin/env node
/** Rasterize structure-roof + green check to PNG masters. */
import fs from 'fs';
...
function main() {
  ...
  strokeLine(c, 256, 520, 512, 248, 56, FG);
  strokeLine(c, 512, 248, 768, 520, 56, FG);
  strokeLine(c, 352, 520, 352, 776, 56, FG);
  strokeLine(c, 672, 520, 672, 776, 56, FG);
  strokeLine(c, 352, 776, 672, 776, 56, FG);
  strokeLine(c, 430, 620, 500, 698, 48, ACCENT);
  strokeLine(c, 500, 698, 710, 430, 48, ACCENT);
