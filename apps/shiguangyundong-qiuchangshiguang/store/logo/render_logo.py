#!/usr/bin/env python3
"""Rasterize store/logo/symbol.svg → 1024 PNG masters (requires cairosvg + Pillow)."""
...
def main() -> None:
    ...
    alpha = fg.split()[3]
    white_rgb = Image.new("RGB", (MASTER, MASTER), (255, 255, 255))
    bg_trans = Image.new("RGBA", (MASTER, MASTER), (0, 0, 0, 0))
    bg_trans.paste(white_rgb, mask=alpha)
    bg_trans.save(ROOT / "foreground.png")
