...
- status: **pass**
- slug: wenbo-xiaoshi-ji
- productVisualType: ops-tool
- platformBiz: false
- contentImages: 4
- checkedAt: 2026-08-29T09:10:34.902Z
...
- B2.7-revoke-direct-tap OK (app/entry/src/main/ets/components/design-system/AppNavBar.ets)
- HUAWEI-简单: 首页有足够区块
- HUAWEI-简单: feature-list 26 项 ✅
- HUAWEI-简单: 2 个文件含写操作 API
- HUAWEI-50104: 7 个业务页
- HUAWEI-50104: differentiation.md 存在
- HUAWEI-50104: 37 处写/提交逻辑

> Re-run: `npm run gate:behavior -- wenbo-xiaoshi-ji`
