...
- status: **pass**
- slug: jujiazhang-jujiazhang
- productVisualType: ops-tool
- platformBiz: true
- contentImages: 15
- checkedAt: 2026-08-31T09:40:19.715Z
...
- Gate C 15 content images (min 2)
...
- HUAWEI-简单: 首页有足够区块
- HUAWEI-简单: feature-list 8 项 ✅
- HUAWEI-简单: 4 个文件含写操作 API
- HUAWEI-50104: 18 个业务页
- HUAWEI-50104: differentiation.md 存在
- HUAWEI-50104: 58 处写/提交逻辑

> Re-run: `npm run gate:behavior -- jujiazhang-jujiazhang`
