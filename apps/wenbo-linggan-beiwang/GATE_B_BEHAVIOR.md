...
- productVisualType: inspiration-memo
- platformBiz: true
- contentImages: 16
- checkedAt: 2026-09-02T07:32:50.746Z
...
- Gate C 16 content images (min 2)
...
- HUAWEI-50104: 52 处写/提交逻辑

> Re-run: `npm run gate:behavior -- wenbo-linggan-beiwang`
