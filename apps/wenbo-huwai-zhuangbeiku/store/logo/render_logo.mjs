/**
 * Rasterize 户外装备库 logo (ridge + check negative space).
 */
import fs from 'fs'
...
function drawMark(size) {
  ...
  fillPoly(
    ...
    size,
    [
      [Math.round(168 * s), Math.round(760 * s)],
      [Math.round(392 * s), Math.round(328 * s)],
      [Math.round(512 * s), Math.round(512 * s)],
      [Math.round(632 * s), Math.round(280 * s)],
      [Math.round(856 * s), Math.round(760 * s)],
    ],
    MARK,
  )
  fillPoly(
    ...
    size,
    [
      [Math.round(430 * s), Math.round(596 * s)],
      [Math.round(502 * s), Math.round(668 * s)],
      [Math.round(690 * s), Math.round(440 * s)],
      [Math.round(646 * s), Math.round(404 * s)],
      [Math.round(502 * s), Math.round(584 * s)],
      [Math.round(474 * s), Math.round(556 * s)],
    ],
    BG,
  )
  return buf
...
console.log('OK rendered 户外装备库 logo PNGs')
